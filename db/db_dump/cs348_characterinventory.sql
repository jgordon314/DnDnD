...
CREATE TABLE `characterinventory` (
  ...
  CONSTRAINT `characterinventory_ibfk_1` FOREIGN KEY (`character_id`) REFERENCES `characters` (`id`),
  CONSTRAINT `characterinventory_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`)
...
INSERT INTO `characterinventory` VALUES (1,1,1,0),(1,2,5,0),(2,2,10,0),(3,2,5,0),(4,2,3,0),(1,3,1,1),(4,3,1,1),(1,4,1,1),(1,5,3,0),(3,5,2,0),(2,6,1,1),(4,6,1,1),(2,7,1,0),(4,8,2,0);
